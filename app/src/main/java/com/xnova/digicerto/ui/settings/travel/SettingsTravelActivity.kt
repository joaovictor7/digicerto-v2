...
import com.xnova.digicerto.databinding.ActivitySettingsTravelBinding
...
class SettingsTravelActivity : BaseActivity() {

    private lateinit var mBinding: ActivitySettingsTravelBinding
    private lateinit var mViewModel: SettingsTravelViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        mBinding = ActivitySettingsTravelBinding.inflate(layoutInflater)
        mViewModel = ViewModelProvider(this).get(SettingsTravelViewModel::class.java)
