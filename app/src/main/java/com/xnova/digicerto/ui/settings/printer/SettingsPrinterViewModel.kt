...
class SettingsPrinterViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val mBluetoothRepository = BluetoothRepository(application)
    ...
    private fun printerValidations(printer: android.bluetooth.BluetoothDevice?): Boolean {
        if (printer == null) {
            mShowAlert.value =
